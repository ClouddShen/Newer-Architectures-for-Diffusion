# Diffusion Models
**Declaration**: This codebase was initially developed by [@dome272](https://github.com/dome272) (check out the original [repository](https://github.com/dome272/Diffusion-Models-pytorch)).
We adapated the code to make it fit with our tasks for the project.
